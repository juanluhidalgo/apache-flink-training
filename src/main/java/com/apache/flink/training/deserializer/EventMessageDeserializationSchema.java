package com.apache.flink.training.deserializer;
...
public class EventMessageDeserializationSchema implements DeserializationSchema<EventMessage>, SerializationSchema<EventMessage> {
